...
class User(db.Model):
    ...
    sent_messages = db.relationship('Message', back_populates='sender', cascade='all,delete')
    recieved_messages = db.relationship('Message', back_populates='recipient', cascade='all,delete')
